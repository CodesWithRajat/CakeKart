...
<head>
    ...
    <title>Bread Details - Admin Dashboard</title>
    <!-- Bootstrap 5 CSS -->
...
<body style="margin: 50px;">
    <h1> List of Bread </h1>
    <a class='btn btn-primary btn-sm' href="./Bread/add.html" role="button">Add Bread </a>
    <br>
    <table class="table">
        <thead>
        <tr>
            ...
            while($row = $result->fetch_assoc()) {
                echo"<tr>
                    ...
                    <td> 
                        ...
                        <a class='btn btn-danger btn-sm' href='./Bread/delete_bread.php?id=$row[id]'>Delete </a>
                    </td>
                </tr>";
