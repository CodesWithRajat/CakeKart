...
<body style="margin: 50px;">
    ...
    <a class='btn btn-primary btn-sm' href="./cookie/add.html" role="button">Add Cookies </a>
    <br>
    <table class="table">
        <thead>
        <tr>
            ...
            while($row = $result->fetch_assoc()) {
                echo"<tr>
                    ...
                    <td> 
                        ...
                        <a class='btn btn-danger btn-sm' href='./cookie/delete_cookie.php?id=$row[id]'>Delete </a>
                    </td>
                </tr>";
